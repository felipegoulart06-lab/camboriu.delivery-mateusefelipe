...
urlpatterns = [
    ...
    path("entregas/nova/", views.delivery_create, name="platform_delivery_create"),
    ...
    path("empresas/<int:pk>/dossie.pdf", views.company_dossier, name="company_dossier"),
    ...
    path("entregadores/<int:pk>/dossie.pdf", views.driver_dossier, name="platform_driver_dossier"),
