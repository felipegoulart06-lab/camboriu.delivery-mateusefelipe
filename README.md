# SC Transporte Executivo Delivery
...
python manage.py bootstrap --nome "SC Transporte Executivo Delivery" --cnpj "00.000.000/0001-00" --master-email diretoria@suaempresa.com.br
```
